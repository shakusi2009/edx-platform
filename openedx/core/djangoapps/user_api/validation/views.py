...
class RegistrationValidationView(APIView):
    """
        ...
        **Example Requests and Responses**
            ...
            GET /api/user/v1/validation/registration/
            >>> {
            >>>     "username": "hi_im_new",
    ...
    def get(self, request):
        ...
        >>>     "password": "password_mslm_in_it_thus_invalid"
        >>> }
        where each key is the appropriate form field name and the value is
        user input and any of its validation dependencies (i.e. for password,
        we depend on username). One may enter individual inputs if needed.
        """
        validation_decisions = {}
        for form_field_key in self.validation_handlers:
            ...
            if form_field_key in request.GET:
